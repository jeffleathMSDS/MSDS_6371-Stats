...
## Historgrams to test assumption of normality
hist(fired)
hist(not.fired)
## QQ Plots to test assumption of normality
qqnorm(fired, main = "Normal Q Q Plot - Fired")
qqnorm(not.fired, main = "Normal Q Q Plot - Not-Fired")
mean (fired)
mean (not.fired)
sd(fired)
sd(not.fired)
